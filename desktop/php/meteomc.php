				...
				<form class="form-horizontal">
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Données à afficher}}</label>
								<div class="col-sm-6">
									<select class="form-control eqLogicAttr" data-l1key="configuration" data-l2key="meteomcmode">
										<option value="daily">{{Prévisions journalières}}</option>
										<option value="periods">{{Prévisions par périodes (nuit, matin, après-midi, soir)}}</option>
										<option value="hours">{{Prévisions horaires pour les 12 prochaines heures}}</option>
									</select>
								</div>
							</div>
						</div>
